...
class dynamic_arg_list
{
    ...
    // templates it doesn't complain about inability to deduce single
    // translation unit for placing vtable. So storage_node_base is made a fake
    // template.
...
#endif
{
  private:
    ...
    template <typename T>
    using stored_type =
        conditional_t<detail::is_string<T>::value &&
